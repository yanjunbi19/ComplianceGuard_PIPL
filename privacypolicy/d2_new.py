...
PRETRAINED_MODEL_PATH = "./models/cpp-chinese-roberta-wwm-ext-transfer/checkpoint-1395"
SAVE_PATH = "./models/roberta-multilabel-classifier-d2n-82-9575-05-50-g"
...
def main():
    ...
    final_datasets = DatasetDict({
        'train': load_dataset("json", data_files=os.path.join(DATA_PATH, "train_da_deduplicated0.jsonl"))['train'],
        'validation': load_dataset("json", data_files=os.path.join(DATA_PATH, "validation_deduplicated0.jsonl"))['train'],
        'test': load_dataset("json", data_files=os.path.join(DATA_PATH, "test_deduplicated0.jsonl"))['train']
    })
    ...
    child_to_parent_map = label_manager.child_to_parent_map
    ...
    trainer = HybridLossTrainer(
        ...
        label_relation_matrix=label_relation_matrix_tensor,
        temperature=TEMPERATURE,
        alpha_large_class=ALPHA_LARGE_CLASS,
        alpha_small_class=ALPHA_SMALL_CLASS,
